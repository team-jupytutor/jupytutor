...
let
  ...
  yarnBin = fetchurl {
    url = "https://repo.yarnpkg.com/3.5.0/packages/yarnpkg-cli/bin/yarn.js";
    hash = "sha512-LccL5fzp9mdW0lsAqIjzymb4a1ArdnUOcrpUzsidp2e5OMVBJFleJvhoglaI4P41UsJsdqMwZzNDBXrK3Vz88g==";
  };
  ...
  cacheDrv = stdenv.mkDerivation {
    ...
    outputHash = "sha512-sxsmlSCytxPAkmYptwXv1DIXASPvg6nSq12wWhHAeOgOT0/aPQIAniidXjhtkqQDNL2e9WbZOXaDFO73T4dkTA==";
  };
